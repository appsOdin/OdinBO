        ...
        * En route se especifican las rutas.
        ...
        if ($role === 'USER') {
            $allowed = [
                ...
                'GET /rrhh/dependencia-firma',
                'POST /rrhh/dependencia-firma/list',
                'POST /rrhh/dependencia-firma/users',
                'POST /rrhh/dependencia-firma/store',
                'POST /rrhh/dependencia-firma/update',
