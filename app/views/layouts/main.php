...
window.APP = {
    ...
    vacationUploadFileToSignUrl: '<?= base_url('rrhh/solicitudes-vacaciones/upload-file-to-sign') ?>',
    ...
    signatureDependencyListUrl: '<?= base_url('rrhh/dependencia-firma/list') ?>',
    signatureDependencyUsersUrl: '<?= base_url('rrhh/dependencia-firma/users') ?>',
    signatureDependencyStoreUrl: '<?= base_url('rrhh/dependencia-firma/store') ?>',
    signatureDependencyUpdateUrl: '<?= base_url('rrhh/dependencia-firma/update') ?>',
